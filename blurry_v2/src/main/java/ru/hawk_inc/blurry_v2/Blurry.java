...
import ru.hawk_inc.blurry_v2.Blurry.ImageComposer.ImageComposerListener;
import ru.hawk_inc.blurry_v2.internal.Blur;
import ru.hawk_inc.blurry_v2.internal.BlurFactor;
import ru.hawk_inc.blurry_v2.internal.BlurTask;
import ru.hawk_inc.blurry_v2.internal.Helper;
...
public class Blurry {
  ...
  public static void delete(final ViewGroup target, int duration) {
    final View view = target.findViewWithTag(TAG);
    if (view != null) {
      Helper.animateDetete(view, duration);
